  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <div className="relative min-h-screen isolate overflow-hidden border-b border-gray-200 bg-white text-stone-900">
          <svg
          ...
          <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex gap-16 lg:px-8 lg:py-24">
            <div className="h-full w-full z-10 flex flex-col items-center gap-4">
              <Icons.Sparkles className="w-14 h-14" />
              <h1 className="tracking-tight text-4xl sm:text-6xl font-bold">
                MagicSearch
              </h1>
              <p className="max-w-xl text-center text-lg text-stone-700">
